...
int main()
{
	...
	//Prends un Pokémon du bench ( stocke) et on le  mets dans mes Pokémon actifs.
	...
	player2.addCardToBench(new PokemonCard("Bulbassaur", "Grass", "Bulbassaur", 1, 100, 2, "LeechSeed", 15, 3, "Vine Whip", 25));
